 ...
 * Invocation command was nin10kit --mode=3 --resize=240x160 WinScreen images/winscreen.png 
 * Time-stamp: Thursday 04/03/2025, 21:40:11
 * 
 * Image Information
 * -----------------
 * images/winscreen.png 240@160
 * 
